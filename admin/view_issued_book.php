<?php
	...
	$book_no = "";
	$student_name = "";
	$query = "select issued1_books.book_name,issued1_books.book_author,issued1_books.book_no,users.name from issued1_books left join users on issued1_books.student_id = users.id where issued1_books.status = 1";
?>
<!DOCTYPE html>
<html>
<head>
